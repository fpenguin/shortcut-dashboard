...
Planned starter packs target tools where keyboard fluency actually pays off: Vim, Neovim, Emacs, tmux, VS Code, Cursor, Figma, Photoshop, Illustrator, Blender, Unity, Unreal Engine, Logic Pro, Ableton Live, Reaper, DaVinci Resolve, Final Cut Pro, Excel, Google Sheets, Obsidian, Linear, Gmail, Superhuman, Raycast, Alfred, Keyboard Maestro, BetterTouchTool, AutoCAD, Fusion 360, KiCad, DataGrip, TablePlus, Finder, Path Finder, PowerToys, Directory Opus, Chrome, Safari, Firefox, Windows and macOS essentials, Microsoft Word, PowerPoint, Outlook, Teams, Zoom, and popular keyboard-first games such as Minecraft Java Edition, League of Legends, Dota 2, Roblox, World of Warcraft, Counter-Strike 2, Fortnite, VALORANT, Apex Legends, Overwatch 2, Rocket League, PUBG Battlegrounds, StarCraft, and more.
